    ...
    Else
        ...
        If frmMain.mnuVerAutomatico.Checked = True Then
            Select Case Numero
                Case 0
                    If frmMain.cCapas.text = 4 Then
                        If LenB(frmMain.mnuVerCapa3.Tag) <> 0 Then frmMain.mnuVerCapa4.Checked = frmMain.mnuVerCapa4.Tag = -1
                    ElseIf frmMain.cCapas.text = 3 Then
...
'*************************************************
    ...
    Select Case Numero
        ...
        Case 1 ' Translados
            ...
            frmMain.PreviewGrh.Visible = False
        ...
        Case 5 ' OBJs
            ...
            frmMain.lCantFunc(Numero - 3).Visible = Ver
            frmMain.cCantFunc(Numero - 3).Visible = Ver
            frmMain.PreviewGrh.Visible = True
