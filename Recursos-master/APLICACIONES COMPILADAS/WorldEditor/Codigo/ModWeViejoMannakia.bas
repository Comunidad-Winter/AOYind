...
'*************************************************
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
            DeSeleccionMap(X, Y) = MapData(CurrentMap).Tile(X + SeleccionIX, Y + SeleccionIY)
        Next
    Next
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
             If MapData(CurrentMap).Tile(X + SeleccionIX, Y + SeleccionIY).Blocked = 1 Then
                MapData(CurrentMap).Tile(X + SeleccionIX, Y + SeleccionIY).Blocked = 0
             Else
                MapData(CurrentMap).Tile(X + SeleccionIX, Y + SeleccionIY).Blocked = 1
            End If
        Next
    Next
    Seleccionando = False
...
'*************************************************
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
             MapData(CurrentMap).Tile(X + SeleccionIX, Y + SeleccionIY) = Vacio
        Next
    Next
    Seleccionando = False
End Sub
...
'*************************************************
    ...
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
            SeleccionMap(X, Y) = MapData(CurrentMap).Tile(X + SeleccionIX, Y + SeleccionIY)
        Next
    Next
End Sub
Public Sub DePegar()
...
'*************************************************
    ...
    For X = 0 To DeSeleccionAncho - 1
        For Y = 0 To DeSeleccionAlto - 1
             MapData(CurrentMap).Tile(X + DeSeleccionOX, Y + DeSeleccionOY) = DeSeleccionMap(X, Y)
        Next
    Next
End Sub
...
'*************************************************
    ...
    For X = 0 To DeSeleccionAncho - 1
        For Y = 0 To DeSeleccionAlto - 1
            DeSeleccionMap(X, Y) = MapData(CurrentMap).Tile(X + SobreX, Y + SobreY)
        Next
    Next
    For X = 0 To SeleccionAncho - 1
        For Y = 0 To SeleccionAlto - 1
             MapData(CurrentMap).Tile(X + SobreX, Y + SobreY) = SeleccionMap(X, Y)
        Next
    Next
    Seleccionando = False
End Sub
...
If X < 1 Or X > MapInfo(CurrentMap).Width Or Y < 1 Or Y > MapInfo(CurrentMap).Height Then
    InMapBounds = False
    Exit Function
End If
