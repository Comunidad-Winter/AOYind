...
If Mapa(0).text > -1 And Aplicar(0).value = 1 Then
    ...
    For X = (PosLim(3).text + 1) To (PosLim(2).text - 1)
        If MapData(CurrentMap).Tile(X, Y).Blocked = 0 Then
            MapData(CurrentMap).Tile(X, Y).TileExit.Map = Mapa(0).text
            If Mapa(0).text = 0 Then
                MapData(CurrentMap).Tile(X, Y).TileExit.X = 0
                MapData(CurrentMap).Tile(X, Y).TileExit.Y = 0
            Else
                MapData(CurrentMap).Tile(X, Y).TileExit.X = X
                MapData(CurrentMap).Tile(X, Y).TileExit.Y = PosLim(4).text
            End If
        End If
    Next
End If
...
If Mapa(1).text > -1 And Aplicar(1).value = 1 Then
    ...
    For Y = (PosLim(1).text + 1) To (PosLim(0).text - 1)
        If MapData(CurrentMap).Tile(X, Y).Blocked = 0 Then
            MapData(CurrentMap).Tile(X, Y).TileExit.Map = Mapa(1).text
                If Mapa(1).text = 0 Then
                    MapData(CurrentMap).Tile(X, Y).TileExit.X = 0
                    MapData(CurrentMap).Tile(X, Y).TileExit.Y = 0
                Else
                    MapData(CurrentMap).Tile(X, Y).TileExit.X = PosLim(6).text
                    MapData(CurrentMap).Tile(X, Y).TileExit.Y = Y
                End If
        End If
    Next
End If
...
If Mapa(2).text > -1 And Aplicar(2).value = 1 Then
    ...
    For X = (PosLim(3).text + 1) To (PosLim(2).text - 1)
        If MapData(CurrentMap).Tile(X, Y).Blocked = 0 Then
            MapData(CurrentMap).Tile(X, Y).TileExit.Map = Mapa(2).text
                If Mapa(2).text = 0 Then
                    MapData(CurrentMap).Tile(X, Y).TileExit.X = 0
                    MapData(CurrentMap).Tile(X, Y).TileExit.Y = 0
                Else
                    MapData(CurrentMap).Tile(X, Y).TileExit.X = X
                    MapData(CurrentMap).Tile(X, Y).TileExit.Y = PosLim(5).text
                End If
        End If
    Next
End If
...
If Mapa(3).text > -1 And Aplicar(3).value = 1 Then
    ...
    For Y = (PosLim(1).text + 1) To (PosLim(0).text - 1)
        If MapData(CurrentMap).Tile(X, Y).Blocked = 0 Then
            MapData(CurrentMap).Tile(X, Y).TileExit.Map = Mapa(3).text
                If Mapa(3).text = 0 Then
                    MapData(CurrentMap).Tile(X, Y).TileExit.X = 0
                    MapData(CurrentMap).Tile(X, Y).TileExit.Y = 0
                Else
                    MapData(CurrentMap).Tile(X, Y).TileExit.X = PosLim(7).text
                    MapData(CurrentMap).Tile(X, Y).TileExit.Y = Y
                End If
        End If
    Next
...
For X = (PosLim(3).text + 1) To (PosLim(2).text - 1)
        If MapData(CurrentMap).Tile(X, Y).TileExit.Map > 0 Then
            Mapa(0).text = MapData(CurrentMap).Tile(X, Y).TileExit.Map
            Exit For
        End If
Next
Aplicar(0).value = 0
...
For Y = (PosLim(1).text + 1) To (PosLim(0).text - 1)
        If MapData(CurrentMap).Tile(X, Y).TileExit.Map > 0 Then
            Mapa(1).text = MapData(CurrentMap).Tile(X, Y).TileExit.Map
            Exit For
        End If
Next
Aplicar(1).value = 0
...
For X = (PosLim(3).text + 1) To (PosLim(2).text - 1)
        If MapData(CurrentMap).Tile(X, Y).TileExit.Map > 0 Then
            Mapa(2).text = MapData(CurrentMap).Tile(X, Y).TileExit.Map
            Exit For
        End If
Next
Aplicar(2).value = 0
...
For Y = (PosLim(1).text + 1) To (PosLim(0).text - 1)
        If MapData(CurrentMap).Tile(X, Y).TileExit.Map > 0 Then
            Mapa(3).text = MapData(CurrentMap).Tile(X, Y).TileExit.Map
            Exit For
        End If
Next
Aplicar(3).value = 0
