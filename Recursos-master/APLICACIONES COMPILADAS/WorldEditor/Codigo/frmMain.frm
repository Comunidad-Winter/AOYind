...
If CD1.FileName <> "" Then
    ...
    If MapInfo(PrevMap).Width <> MapInfo(CurrentMap).Width Or MapInfo(PrevMap).Height <> MapInfo(CurrentMap).Height Then
        CurrentMap = PrevMap
        Call MsgBox("Los mapas no son del mismo tamaño, esta función sirve para comparar 2 versiones de un mismo mapa", vbExclamation)
        Close #155
...
Dim W As Integer
W = Val(InputBox("Ingrese el ancho del mapa: (Si es mas chico que el actual se perderá parte del mapa.", "Dimension", MapInfo(CurrentMap).Width))
If W < 10 Or W > 1100 Then
    Call MsgBox("Valor de ancho invalido.", vbExclamation)
    Exit Sub
End If
Dim H As Integer
H = Val(InputBox("Ingrese el alto del mapa: (Si es mas chico que el actual se perderá parte del mapa.", "Dimension", MapInfo(CurrentMap).Height))
...
End If
Dim H As Integer
H = Val(InputBox("Ingrese el alto del mapa: (Si es mas chico que el actual se perderá parte del mapa.", "Dimension", MapInfo(CurrentMap).Width))
If H < 10 Or H > 1500 Then
    Call MsgBox("Valor de alto invalido.", vbExclamation)
    Exit Sub
End If
