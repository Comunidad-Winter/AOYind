...
Private Sub cmdCompress_Click()
    ...
    ElseIf oWavs.Value Then
        SourcePath = App.Path & "\EXTRACCIONES\Wav\" & txtVersion.Text & "\"
     ...
     ElseIf oWavs.Value Then
        ...
        GRH_RESOURCE_FILE = "Wav.AO"
        GRH_PATCH_FILE = "Wav.PATCH"
     ElseIf oMapas.Value Then
        SourcePath = App.Path & "\EXTRACCIONES\Mapas\" & txtVersion.Text & "\"
        OutputPath = App.Path & RESOURCE_PATH & "Mapas\" & txtVersion.Text & "\"
        GRH_SOURCE_FILE_EXT = ".*"
        GRH_RESOURCE_FILE = "Mapa" & txtVersion.Text & ".AO"
        GRH_PATCH_FILE = "Map.PATCH"
    ElseIf oInits.Value Then
        SourcePath = App.Path & "\EXTRACCIONES\Init\" & txtVersion.Text & "\"
...
Private Sub cmdExtract_Click()
    ...
    Dim OutputPath As String
        ...
        GRH_RESOURCE_FILE = "Graphics.AO"
        GRH_PATCH_FILE = "Graphics.PATCH"
        ResourcePath = App.Path & "\RECURSOS\" & GRAPHIC_PATH & "\" & txtVersion.Text & "\"
    ElseIf oInterfaces.Value Then
        ...
        GRH_RESOURCE_FILE = "Interface.AO"
        GRH_PATCH_FILE = "Interface.PATCH"
        ResourcePath = App.Path & "\RECURSOS\" & "\Interface\" & txtVersion.Text & "\"
    ElseIf oWavs.Value Then
        ...
        GRH_RESOURCE_FILE = "Wav.AO"
        GRH_PATCH_FILE = "Wav.PATCH"
        ResourcePath = App.Path & "\RECURSOS\" & "\Wav\" & txtVersion.Text & "\"
    ElseIf oMapas.Value Then
        SourcePath = App.Path & "\Mapas\"
        OutputPath = App.Path & EXTRACT_PATH & "Mapas\" & txtVersion.Text & "\"
        GRH_SOURCE_FILE_EXT = ".*"
        GRH_RESOURCE_FILE = "Mapa" & txtVersion.Text & ".AO"
        GRH_PATCH_FILE = "Map.PATCH"
        ResourcePath = App.Path & "\RECURSOS\" & "\Mapas\" & txtVersion.Text & "\"
    ElseIf oInits.Value Then
        SourcePath = App.Path & "\Inits\"
        OutputPath = App.Path & EXTRACT_PATH & "Init\" & txtVersion.Text & "\"
        ResourcePath = App.Path & "\RECURSOS\" & "\Inits\" & txtVersion.Text & "\"
        GRH_SOURCE_FILE_EXT = ".*"
        GRH_RESOURCE_FILE = "Mapa" & txtVersion.Text & ".AO"
        GRH_PATCH_FILE = "Map.PATCH"
    End If
